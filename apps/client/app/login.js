  ...
  async function handleSignUp() {
    ...
    try {
      ...
      if (result.session) {
        ...
        Alert.alert("Kayıt oluşturuldu", "E-posta adresine gelen doğrulama bağlantısını açtıktan sonra giriş yap.");
      }
    } catch (error) {
